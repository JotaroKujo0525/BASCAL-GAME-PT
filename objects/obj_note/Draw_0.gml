...
draw_sprite(txb_spr, 0, 195, 104);
if place_meeting(195, 104, obj_eden) {
draw_sprite_ext(spr_note_text, txb_img, textbox_x + 32, textbox_y, textbox_width/txtb_spr_note_w, textbox_height/txtb_spr_note_h, 0, c_white, 1);
